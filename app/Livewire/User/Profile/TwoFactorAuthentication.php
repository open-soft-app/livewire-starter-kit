...
class TwoFactorAuthentication extends Component
{
    ...
    public function confirm(ConfirmTwoFactorAuthentication $confirm): void
    {
        ...
        try {
            ...
            throw ValidationException::withMessages(['code' => [__('profile.two_factor.invalid_code')]]);
        } catch (Exception $e) {
            report($e);
        }
    ...
    {
        return [
            'current_password' => __('profile.attributes.current_password'),
            'code'             => __('profile.attributes.code'),
        ];
    }
